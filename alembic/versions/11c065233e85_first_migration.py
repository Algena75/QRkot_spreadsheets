...
Revision ID: 11c065233e85
Revises: 
Create Date: 2023-10-19 17:00:26.114494
...
def upgrade():
    ...
    sa.CheckConstraint('full_amount > 0', name='check_positive'),
    sa.CheckConstraint('invested_amount >= 0', name='check_non_negative'),
